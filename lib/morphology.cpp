...
coord
top_right(int x, int y, int xoffs, int yoffs)
{
    return coord(x + xoffs, y + yoffs);
}
coord
top_centr(int x, int y, int xoffs, int yoffs)
{
    return coord(x - yoffs, y - xoffs);
}
coord
bot_centr(int x, int y, int xoffs, int yoffs)
{
    return coord(x - yoffs, y + xoffs);
}
coord
bot_right(int x, int y, int xoffs, int yoffs)
{
    return coord(x + xoffs, y - yoffs);
}
